...
public class BlockCopperFence extends BlockFence {

	public BlockCopperFence(Material par3Material) {

		super("ironfence:copper", Material.iron);
		this.setBlockName("copperFence");
	...
	public boolean onBlockActivated(World world, int i, int j, int k,
		...
		if (entity.inventory.getCurrentItem() != null
			...
			if (entity instanceof EntityPlayer)
				entity.inventory.consumeInventoryItem(Items.gold_ingot);
		}
